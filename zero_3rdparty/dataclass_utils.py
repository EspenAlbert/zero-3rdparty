...
def copy(instance: T, exclude: Container[str] | None = None, update: dict | None = None) -> T:
    if exclude:
...
def key_values(instance: object, filter: Callable[[str], bool] | None = None) -> dict[str, Any]:
    return {
